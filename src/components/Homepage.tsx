...
import { Zap, ArrowRight, Sparkles, Target, Beaker, Palette, Code, GitBranch, BarChart3, TestTube, Layers, Workflow } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            <div className="bg-white border border-gray-200 rounded-2xl p-8 max-w-2xl mx-auto">
              <h3 className="text-2xl font-semibold text-black mb-4">🧠 Exports clean, production-ready Python and JS for Langchain</h3>
